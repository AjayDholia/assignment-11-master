...
function FreshOrders() {
    ...
    async function DeleteRecords(id) {
        ...
        try {
            ...
            const response = await axios.get(apiUrl + `/assignment/delete/?_id=${id}`,
                    ...
                    <Tbody>
                        {(assignments.length === 0) ? <></> : assignments.map(
                            (assignment, index) => <Tr key={assignment.id}>
                                ...
                                <Td><Button style={{ color: "red" }} onClick={() => DeleteRecords(assignment.id)}>Delete recordes</Button></Td>
                                <Td>
                                    <HStack>
                                        {
                                                            ...
                                                            <HStack>
                                                                {
                                                                    (assignment.status === 'Fresh Order') ? <>
                                                                        ...
                                                                        <Button
                                                                            display={(localStorage.getItem('userRole') === "Operator" || localStorage.getItem("userRole") === "Super Admin" || localStorage.getItem("userRole") === "Admin") ? 'flex' : 'none'}
                                                                            onClick={async () => openExpertModal(index)}>Quote Expert</Button>
                                                                        <Button
                                                                            display={(localStorage.getItem('userRole') === "Operator" || localStorage.getItem("userRole") === "Super Admin" || localStorage.getItem("userRole") === "Admin") ? 'flex' : 'none'}
                                                                            onClick={async () => openDoableResponsesModal(index)}>Doable Responses</Button>
                                                                        <Button

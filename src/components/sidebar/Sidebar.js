...
const mobTab = (event) => {
  ...
  // console.log(name);
  for (let i = 0; i < parentElement.querySelectorAll('.ShowSideClick').length; i++) {
    if (i == name) {
      parentElement.querySelectorAll('.ShowSideClick')[i].classList.add("active");
    } else {
      parentElement.querySelectorAll('.ShowSideClick')[i].classList.remove("active");
    }
  }
}
...
function Examplee() {
  ...
  const dropSupport = () => {
    // console.log("hello");
    var hideShow = document.getElementsByClassName('dropSupport')[0].style.display;
    // console.log(hideShow);
    if (hideShow === "block") {
  ...
  const dropOrder = () => {
    // console.log("hello");
    var hideShow = document.getElementsByClassName('dropOrder')[0].style.display;
    // console.log(hideShow);
    if (hideShow === "block") {
            ...
            <DrawerBody display={{ lg: 'none' }}>
              {
                (userRole === "Sales") ? <>
                  <Box fontSize='xl' onClick={dropSupport}>
                    ...
                    <Box fontSize='md'>
                      <ul className='dropSupport'>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="9" className='hyi'>Home Chat Queue</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="10" className='hyi'>Sales Chat Queue</li>
                      </ul>
                    </Box>
                  </Box>
                  <Box fontSize='xl' onClick={dropOrder}>Orders
                    ...
                    <Box fontSize='md'>
                      <ul className='dropOrder'>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="12" id="hh1">Fresh</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="13"  id="hh2">CP1 Pending</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="14"  id="hh3">CP1 Done</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="15"  id="hh4">Confirmation Asked</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="16" className='hyi'>Assigned Expert</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="17" className='hyi'>Raw Submission</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="18" className='hyi'>Internal Rework</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="19" className='hyi'>Proof Read</li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="20" className='hyi'>CP2 Done </li>
                        <li onClick={(e) => { mobTab(e); onClose(); }} name="21" className='hyi'>Client Rework</li>
                      </ul>
                    </Box>
                  ...
                  :
                  (userRole === "Operator") ? <>
                    <Box onClick={mobTab} name="11" fontSize='xl' className='hyi'>Calendar</Box>
                    <Box fontSize='xl' onClick={dropOrder}>Orders
                    <ChevronDownIcon />
                    <Box fontSize='md'>
                      <ul className='dropOrder'>
                    ...
                    (userRole === 'Super Admin' || userRole === 'Admin') ? <>
                      <Box fontSize='xl' onClick={dropp} >Admin
                        ...
                        <Box fontSize='md'>
                          <ul className='drop'>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="0" className='hyi'>Assignments</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="1" className='hyi'>Subjects</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="2" className='hyi'>New User</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="3" className='hyi'>Vendors</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="4" className='hyi'>Admin</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="5" className='hyi'>Operator</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="6" className='hyi'>QC</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="7" className='hyi'>Sales</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="8" className='hyi'>Experts </li>
                          </ul>
                        </Box>
                      </Box>
                      <Box fontSize='xl' onClick={dropSupport}>
                      ...
                      <Box onClick={(e) => { mobTab(e); onClose(); }} name="11" fontSize='xl'>Calendar</Box>
                      <Box fontSize='xl' onClick={dropOrder}>Orders
                        <ChevronDownIcon />
                        <Box fontSize='md'>
                          <ul className='dropOrder'>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="12" className='hyi'>Fresh</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="13" className='hyi'>CP1 Pending</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="14" className='hyi'>CP1 Done</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="15" className='hyi'   id="hh4">Confirmation Asked</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="16" className='hyi'>Assigned Expert</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="17" className='hyi'>Raw Submission</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="18" className='hyi'>Internal Rework</li>
                            <li onClick={(e) => { mobTab(e); onClose(); }} name="19" className='hyi'>Proof Read</li>
